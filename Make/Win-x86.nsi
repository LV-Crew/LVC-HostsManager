...
Section "install" ;No components page, name is not important
  ...
  ; Put file there
  File "..\Packages\Win-x86.Setup\LV-Crew.HostsManager.exe"
  File "..\Packages\Win-x86.Setup\cert.pem"
  File "..\Packages\Win-x86.Setup\LV-Crew.HostsManager.Icon.ico"
  SetOutPath "$INSTDIR\certutil"
  File "..\Packages\Win-x86.Setup\certutil\*.*"
