...
LicenseData "Win-x86.Setup\license.rtf"
...
Section "install" ;No components page, name is not important
  ...
  ; Put file there
  File "Win-x86.Setup\LV-Crew.HostsManager.exe"
  File "Win-x86.Setup\cert.pem"
  File "Win-x86.Setup\LV-Crew.HostsManager.Logo.ico"
  SetOutPath "$INSTDIR\certutil"
  File "Win-x86.Setup\certutil\*.*"
