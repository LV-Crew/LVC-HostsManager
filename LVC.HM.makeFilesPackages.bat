...
copy .\Readme.txt .\LVC.HM.Packages\LVC.HM.Win-x64.Archive\Readme.txt
copy .\Readme.txt .\LVC.HM.Packages\LVC.HM.Win-x64.Setup\Readme.txt
copy .\Readme.txt .\LVC.HM.Packages\LVC.HM.Win-x86.Archive\Readme.txt
copy .\Readme.txt .\LVC.HM.Packages\LVC.HM.Win-x86.Setup\Readme.txt

copy .\License.rtf .\LVC.HM.Packages\LVC.HM.Win-x64.Archive\License.rtf
copy .\License.rtf .\LVC.HM.Packages\LVC.HM.Win-x64.Setup\License.rtf
copy .\License.rtf .\LVC.HM.Packages\LVC.HM.Win-x86.Archive\License.rtf
copy .\License.rtf .\LVC.HM.Packages\LVC.HM.Win-x86.Setup\License.rtf
